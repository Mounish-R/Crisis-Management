...
//         setFormData({ name: '', email: '', phone: '', address: '', availability: '' });
//       } else {
...
//           <textarea name="availability" placeholder="Availability and Skills" value={formData.availability} onChange={handleChange} required></textarea>
